...
/**
 * Validates the HS256 token issued by the auth-service and rebuilds the
 * {@link org.springframework.security.core.Authentication} from its claims
 * (userId + roles). No call to the auth-service or the users table is required
